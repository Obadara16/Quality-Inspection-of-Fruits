%Author Name: Obadara Roqeeb Ajibola
%Matric Number:186347
% Project Title: Quality Inspection of Fruit Surface Defect Using Image
% Processing
% This is the start of the project.
% This aspects segments the images into 3 clusters a nd determines the
% percentage area of defect.
clc
close all 
clear all
...
%figure, imshow(I); title('Query Fruit Image');
...
%% The next aspect is the classifier model file.
